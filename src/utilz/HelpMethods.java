...
public class HelpMethods {
    ...
    public static boolean IsProjectileHittingLevel(Projectile p, int[][] lvlData){
        return IsSolid(p.getHitbox().x + p.getHitbox().width/2, p.getHitbox().y + p.getHitbox().height/2, lvlData); //we are considering center of cannon ball rather than top left 
    }
    ...
    public static boolean IsEntityOnFloor(Rectangle2D.Float hitbox, int[][] lvlData) {
        // check the pixel bottomleft and bottomright
    ...
    public static ArrayList<Pirate> GetCrabs(BufferedImage img) {
